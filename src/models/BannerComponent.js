 ...
 * with headline text, background images, and call-to-action functionality.
 */
...
class BannerComponent {
    ...
    /**
     * Clone the BannerComponent
     * @returns {BannerComponent} Cloned instance
     */
    clone() {
