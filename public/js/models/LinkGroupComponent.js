/**
 * LinkGroupComponent Model - Client Side
 ...
 * containing collections of links on the client side.
 */
...
class LinkGroupComponent {
     ...
     */
    generateId() {
        return 'linkgroup-' + Date.now() + '-' + Math.random().toString(36).substr(2, 9);
    }
...
window.LinkGroupComponent = LinkGroupComponent;
